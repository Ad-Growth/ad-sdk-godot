...
class InterstitialAdPlugin(godot: Godot?) : GodotPlugin(godot) {
    private val mainScope = CoroutineScope(Dispatchers.Main)
    private val mAds: HashMap<String, InterstitialAd> = HashMap()

    override fun getPluginName() = BuildConfig.INTERSTITIAL_AD_PLUGIN_NAME
    ...
    fun load(instanceId: String) {
        mAds[instanceId]?.setListener(object : InterstitialAd.Listener {
